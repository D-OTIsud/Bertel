...
-- `auberge_collective_stars` retiré à la source (§206, 16s) : catégorie DÉCLARÉE
-- (L325-1), jamais classée par Atout France — l'insertion §71 était un excès de périmètre.
