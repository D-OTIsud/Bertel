...
import PublicationsPageComponent from '@/views/PublicationsPage';
...
export default function PublicationsPage() {
  ...
  if (!demoMode && isDemoOnlyModule('/publications')) return <FeatureUnavailable path="/publications" />;
  return <PublicationsPageComponent />;
}
