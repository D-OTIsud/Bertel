...
// Échéances de démo RELATIVES à aujourd'hui : le kanban ouvre sur une fenêtre glissante
...
const demoDueAt = (offsetDays: number): string => new Date(Date.now() + offsetDays * DEMO_DAY_MS).toISOString();
...
export const mockCrmTasks: CrmTask[] = [
  ...
  { id: 'task-1', objectId: 'obj-1', objectName: 'Hotel Basalte & Lagon', actorId: 'actor-1', actorName: 'Mme Marie Hoarau', title: 'Rappeler le directeur', description: null, status: 'todo', priority: 'high', dueAt: demoDueAt(-2), assignees: [{ userId: 'usr-local-marie', displayName: 'Marie D.' }, { userId: 'usr-local-jean', displayName: 'Jean P.' }], createdById: 'usr-local-marie', createdByName: 'Marie D.', ownerId: 'usr-local-marie', ownerName: 'Marie', relatedInteractionId: 'int-1', relatedInteractionSubject: 'Demande de visite guidée', relatedInteractionStatus: 'planned' },
  { id: 'task-2', objectId: 'obj-2', objectName: 'Le Comptoir des Epices', actorId: null, actorName: null, title: 'Valider le contrat photo', description: null, status: 'in_progress', priority: 'medium', dueAt: demoDueAt(1), assignees: [{ userId: 'usr-local-marie', displayName: 'Marie D.' }], createdById: 'usr-local-jean', createdByName: 'Jean P.', ownerId: 'usr-local-marie', ownerName: 'Marie', relatedInteractionId: null, relatedInteractionSubject: null, relatedInteractionStatus: null },
  { id: 'task-3', objectId: 'obj-3', objectName: 'Sentier des Trois Cascades', actorId: null, actorName: null, title: 'Confirmer les horaires d hiver', description: null, status: 'done', priority: 'low', dueAt: null, assignees: [{ userId: 'usr-local-luc', displayName: 'Luc T.' }], createdById: null, createdByName: null, ownerId: 'usr-local-luc', ownerName: 'Luc', relatedInteractionId: null, relatedInteractionSubject: null, relatedInteractionStatus: null },
];
