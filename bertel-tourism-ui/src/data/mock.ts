...
export const mockCrmTasks: CrmTask[] = [
  ...
  { id: 'task-1', objectId: 'obj-1', objectName: 'Hotel Basalte & Lagon', actorId: 'actor-1', actorName: 'Mme Marie Hoarau', title: 'Rappeler le directeur', description: null, status: 'todo', priority: 'high', dueAt: demoDate(-2), createdAt: demoDate(-5), assignees: [{ userId: 'usr-local-marie', displayName: 'Marie D.' }, { userId: 'usr-local-jean', displayName: 'Jean P.' }], createdById: 'usr-local-marie', createdByName: 'Marie D.', ownerId: 'usr-local-marie', ownerName: 'Marie', relatedInteractionId: 'int-1', relatedInteractionSubject: 'Demande de visite guidée', relatedInteractionStatus: 'new' },
  { id: 'task-2', objectId: 'obj-2', objectName: 'Le Comptoir des Epices', actorId: null, actorName: null, title: 'Valider le contrat photo', description: null, status: 'in_progress', priority: 'medium', dueAt: demoDate(1), createdAt: demoDate(-10), assignees: [{ userId: 'usr-local-marie', displayName: 'Marie D.' }], createdById: 'usr-local-jean', createdByName: 'Jean P.', ownerId: 'usr-local-marie', ownerName: 'Marie', relatedInteractionId: null, relatedInteractionSubject: null, relatedInteractionStatus: null },
