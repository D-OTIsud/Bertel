...
export const mockCrmTasks: CrmTask[] = [
  ...
  { id: 'task-1', objectId: 'obj-1', objectName: 'Hotel Basalte & Lagon', actorId: 'actor-1', actorName: 'Mme Marie Hoarau', title: 'Rappeler le directeur', description: null, status: 'todo', priority: 'high', dueAt: demoDate(-2), createdAt: demoDate(-5), assignees: [{ userId: 'usr-local-marie', displayName: 'Marie D.' }, { userId: 'usr-local-jean', displayName: 'Jean P.' }], createdById: 'usr-local-marie', createdByName: 'Marie D.', ownerId: 'usr-local-marie', ownerName: 'Marie', relatedInteractionId: 'int-1', relatedInteractionSubject: 'Demande de visite guidée', relatedInteractionStatus: 'planned' },
