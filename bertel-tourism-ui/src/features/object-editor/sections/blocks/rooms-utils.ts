...
// Room media (object_room_type_media) link helpers now live in widgets/media-links.ts, shared with
// itinerary stages (§111 closeout). RoomEditModal consumes them via the <MediaLinkField> widget.
