...
export function fullModulesFixture(): ObjectWorkspaceModules {
  return {
    ...
    activity: {
      ...
      equipmentProvidedDetails: 'Casque',
      difficultyOptions: [{ id: '3', code: '3', label: 'Modéré' }],
      unavailableReason: null,
    },
    ...
    itinerary: {
      ...
      stageKindOptions: [
        { id: 'depart', code: 'depart', label: 'Départ' },
        { id: 'etape', code: 'etape', label: 'Étape' },
        { id: 'point_interet', code: 'point_interet', label: "Point d'intérêt" },
      ...
      stages: [{ recordId: 'st1', name: 'Belvédère du Maïdo', description: 'Parking', position: '1', kind: 'panorama', lng: '55.5', lat: '-21', mediaIds: [] }],
      sectionsCount: 1,
      profilesCount: 1,
