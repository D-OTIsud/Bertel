...
import { listAiProviders, upsertAiProvider, setActiveAiProvider } from '../../services/ai-provider';
...
describe('AiProviderSettings', () => {
  it('lists configured providers with their active state', async () => {
  ...
  it('activates an inactive provider', async () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Activer' })); // only the inactive one has it
  ...
  it('loads a provider into the form for editing (key stays blank)', async () => {
    ...
    // form-specific hint (distinct from the list row's "clé configurée ✓")
