...
- `actor_object_role` ← `current_user_crm_actor_ids`, `current_user_extended_object_ids`, `current_user_portal_object_ids`, `export_actor_capabilities`, `export_actor_contacts`, `get_actor_data` …
...
- `object_classification` ← `capture_metric_snapshots`, `commit_staging_to_public`, `enforce_classification_single_selection`, `get_active_object_documents`, `get_active_object_documents_unfiltered_20260908`, `get_dashboard_distinction_overview` …
...
- `object_iti_stage_media` ← `get_object_resource`, `seed_test_media`
- `object_language` ← `get_object_resource`, `refresh_object_filter_caches`, `save_object_commercial`
- `object_legal` ← `audit_legal_compliance`, `check_object_legal_compliance`, `get_active_object_documents`, `get_active_object_documents_unfiltered_20260908`, `get_expiring_legal_records`, `get_object_legal_compliance` …
- `object_list` ← `backfill_list_feature_notifications`, `build_list_detail_json`, `delete_list`, `duplicate_list`, `ensure_list_share_link`, `get_public_list_by_token` …
- `object_list_item` ← `duplicate_list`, `list_effective_object_ids`, `list_selection_emails`, `set_list_items`
...
- `object_menu` ← `get_object_resource`, `refresh_object_filter_caches`, `search_events_by_restaurant_cuisine`, `search_restaurants_by_cuisine`, `seed_test_facets`, `seed_test_media` …
- `object_menu_item` ← `get_object_resource`, `refresh_object_filter_caches`, `search_events_by_restaurant_cuisine`, `search_restaurants_by_cuisine`, `seed_test_facets`, `seed_test_media` …
...
- `object_menu_item_media` ← `get_object_resource`, `seed_test_media`
...
- `object_room_type` ← `get_object_resource`, `get_object_room_types`, `seed_test_facets`, `seed_test_media`
- `object_room_type_amenity` ← `get_object_resource`, `get_object_room_types`
- `object_room_type_bed` ← `get_object_resource`
- `object_room_type_media` ← `get_object_resource`, `get_object_room_types`, `seed_test_media`
...
- `org_branding_settings` ← `get_app_branding`, `get_org_branding`, `get_org_smtp`, `get_org_smtp_secret`, `upsert_org_branding`
