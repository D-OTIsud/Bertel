...
## Summary
- authorable object-attached tables: **67** — emitted by a detected consumer read: **66** — candidate gaps: **1**
...
- `object_act` ← `get_object_resource`
...
- `object_menu` ← `get_object_resource`, `refresh_object_filter_caches`, `search_events_by_restaurant_cuisine`, `search_restaurants_by_cuisine`, `trg_refresh_caches_from_menu_item_link`, `trg_refresh_caches_from_object_menu_item`
...
- `object_room_type` ← `get_object_resource`, `get_object_room_types`
