...
| Reconstruction SQL complète | **Non validée** : défaut préexistant de droits de lecture acteur avec le bootstrap local utilisé. Aucun accès brut global ajouté pour contourner l’échec. |
